...
That is the first attempt to write the concise The Netspaces first of all the user and later also the programmer documentation. One of the most often applied applications in The Netspaces is the texteditor application - the programmer text editor where you can code very efficiently in the programmer mode.
